...
user in an INI file next to RSSOwlPortable.exe called RSSOwlPortable.ini.
...
copy AppNamePortable.ini from this directory to RSSOwlPortable.ini next to
RSSOwlPortable.exe. The options in the INI file are as follows:
